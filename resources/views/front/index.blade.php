        ...
        <div  id="top" class="callbacks_container">
            <ul class="rslides" id="slider4">
                @foreach(\App\Slider::all() as $key => $value)
                    <li>
                        <img style="height:400px;" src="{{asset(\App\Helper\mHelper::largeImage($value['image']))}}" alt=""/>
                    </li>
                @endforeach
            </ul>
        </div>
            ...
            <div class="about-top grid-1">
                <div class="col-md-4 about-left">
                    <figure class="effect-bubba">
                        <img class="img-responsive" src="{{asset('images/kitaplar/06.jpg')}}" alt=""/>
                        <figcaption>
                ...
                <div class="col-md-4 about-left">
                    <figure class="effect-bubba">
                        <img class="img-responsive" src="{{asset('images/kitaplar/02.jpg')}}" alt=""/>
                        <figcaption>
                ...
                <div class="col-md-4 about-left">
                    <figure class="effect-bubba">
                        <img class="img-responsive" src="{{asset('images/kitaplar/03.jpg')}}" alt=""/>
                        <figcaption>
